...
events = Event.create!([
  ...
  start_time: DateTime.new(2025, 11, 15, 1, 30),
  end_time: DateTime.new(2025, 11, 15, 3, 30),
  ...
  start_time: DateTime.new(2025, 9, 19, 3, 30),
  end_time: DateTime.new(2025, 9, 19, 5, 30),
  ...
  start_time: DateTime.new(2025, 10, 7, 4, 30),
  end_time: DateTime.new(2025, 10, 7, 6, 30),
  location: "Katie's House",
  user_id: users[2].id}, 
  {title: "Cake Picnic", 
  description: "Bring a cake to share!", 
  start_time: DateTime.new(2025, 12, 15, 1, 30),
  end_time: DateTime.new(2025, 12, 15, 3, 30),
  location: "The Park",
  user_id: users[0].id}, 
